...
public class CurvySplinePathMeshBuilderInspector : Editor
{
    ...
    SerializedProperty tCreateCollider;
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(tCreateCollider, new GUIContent("Refresh Mesh Collider", "Refresh Mesh Collider (if present)"));
    ...
    public void SaveMesh()
    {
        ...
        if (!string.IsNullOrEmpty(path)) {
            ...
            newmesh.vertices = Target.Mesh.vertices;
            newmesh.triangles = Target.Mesh.triangles;
            newmesh.uv = Target.Mesh.uv;
            newmesh.uv1 = Target.Mesh.uv1;
            newmesh.uv2 = Target.Mesh.uv2;
            newmesh.normals = Target.Mesh.normals;
            newmesh.colors = Target.Mesh.colors;
            newmesh.tangents = Target.Mesh.tangents;
